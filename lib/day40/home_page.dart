...
class HomePage40 extends StatefulWidget {
  const HomePage40({Key? key}) : super(key: key);

  @override
  HomePage40State createState() => HomePage40State();
}

class HomePage40State extends State<HomePage40> {
  ...
  Widget build(BuildContext context) {
    final chart = PieChart(
      ...
      centerText: _showCenterText ? "Pie Chart" : null,
